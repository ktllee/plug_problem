...
description:
    ...
    !!! difference from brute.py:  made python 3.7 friendly;
    can't figure out how to update to 3.8 on High Sierra.
    basically swaps math.comb() for formula with math.factorial()
...
def twosearch(seed, maxcount, maxlen = 50, setlim = 2):
    ...
    total = math_comb(maxlen, setlim) * (maxcount**setlim) * (2**setlim)
